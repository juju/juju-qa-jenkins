...
class ARMClient:
    ...
    def init_services(self):
        ...
        self.credentials = ClientSecretCredential(
            client_id=self.client_id, client_secret=self.secret, tenant_id=self.tenant)
...
class ResourceGroupDetails:
    ...
    def load_details(self):
        self.deployments = list(self.client.resource.deployments.list_by_resource_group(self.name))
        self.is_loaded = True
    ...
    def delete(self):
        ...
        """
        return self.client.resource.resource_groups.begin_delete(self.name)
    ...
    def delete_vm(self, name):
        ...
        Returns a AzureOperationPoller.
        """
        return self.client.compute.virtual_machines.begin_delete(self.name, name)
