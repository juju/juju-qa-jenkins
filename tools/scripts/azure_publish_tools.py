...
RELEASED = 'released'
PROPOSED = 'proposed'
PURPOSES = (RELEASED, PROPOSED)
JUJU_DIST = 'juju-agents'
...
def get_md5content(local_path):
    ...
    base64_md5 = base64.encodebytes(md5.digest()).strip()
    return base64_md5.decode("utf-8")
